...
def create(in_file, out_file):
    ...
    for i in range(len(traj_data)):
        ...
        if start_time_window.day != temp_time.day or start_time_window.hour - temp_time.hour > 5:
            going_time = datetime(start_time.year, start_time.month, start_time.day, start_time.hour, 0, 0)
        if start_time_window.hour == going_time.hour and start_time_window.minute == going_time.minute and start_time_window.day == going_time.day:
            if start_time_window.hour == 6 or start_time_window.hour == 7 or start_time_window.hour == 15 or start_time_window.hour == 16:
            ...
            if abs(start_time_window.hour - going_time.hour) > 5:
                going_time = datetime(start_time.year, start_time.month, start_time.day, start_time.hour, 0, 0)
...
def main():
    ...
    in_file = 'testing/test2_20min_avg_travel_time'
    out_file = 'testing/test2_fill_travel_time'
