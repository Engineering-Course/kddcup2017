...
TRAINING_FLAG = True
EPOCH = 3000
SNAPSHOT_DIR = './checkpoint5'
LOG_DIR = './logs/five'
TRAIN_ID_FILE = 'dataset/dataSets/train_5_id.txt'
    ...
    if TRAINING_FLAG:
        ...
        for ee in xrange(EPOCH):
            ...
            for idx in xrange(0, batch_idxs):
                ...
                summary, _ = sess.run([loss_sum, optimizer], feed_dict={data5: x_5, label5: y_5})
            ...
            print('test_res: {:f}, epoch {:f}, step {:d}'.format(test_res5, ee, counter))
            fi.write('test_res: {:f}, epoch {:f}, step {:d}\n'.format(test_res5, ee, counter))
        ...
        print('test_res: {:f}'.format(test_res5))
