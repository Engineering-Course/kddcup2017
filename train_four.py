    ...
    if TRAINING_FLAG:
        ...
        for ee in xrange(EPOCH):
            ...
            for idx in xrange(0, batch_idxs):
                ...
                summary, _ = sess.run([loss_sum, optimizer], feed_dict={data4: x_4, label4: y_4})
            ...
            print('test_res: {:f}, epoch {:f}, step {:d}'.format(test_res4, ee, counter))
            fi.write('test_res: {:f}, epoch {:f}, step {:d}\n'.format(test_res4, ee, counter))
        ...
        print('test_res: {:f}'.format(test_res4))
