...
TRAINING_FLAG = True
EPOCH = 3000
SNAPSHOT_DIR = './checkpoint2'
LOG_DIR = './logs/two'
TRAIN_ID_FILE = 'dataset/dataSets/train_2_id.txt'
    ...
    if TRAINING_FLAG:
        ...
        for ee in xrange(EPOCH):
            ...
            for idx in xrange(0, batch_idxs):
                ...
                summary, _ = sess.run([loss_sum, optimizer], feed_dict={data2: x_2, label2: y_2})
            ...
            print('test_res: {:f}, epoch {:f}, step {:d}'.format(test_res2, ee, counter))
            fi.write('test_res: {:f}, epoch {:f}, step {:d}\n'.format(test_res2, ee, counter))
        ...
        print('test_res: {:f}'.format(test_res2))
